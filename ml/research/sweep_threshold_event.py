"""
⚠️ 口径警告（2026-06-27）：本脚本的事件级 P/R 用"几何比对"（信号日 vs swing low 中心 ±k），
   与训练 label 列不一致，P/R 数字偏乐观。**门槛/精召对比请用 ml/research/eval_by_label.py。**
   本脚本的"阈值过低反致连续加仓""信号簇"洞察不依赖 GT 口径，仍有参考价值。
